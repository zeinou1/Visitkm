...
import { initialProfile, userProfile } from "../Features/UsersSlice/ProfileSlice.jsx";
        ...
        <nav className="nav__wrapper flex justify-between items-center mx-auto pt-4  ">
          ...
          >
            ...
            <div className="absolute lg:hidden bottom-4 transform translate-x-1/2 -translate-y-1/2 right-1/2">
              <button className="px-4 py-2 text-center rounded-md text-white  bg-slate-700 lg:block mr-3 ">
          ...
          <div className="nav__right ">
            <div className="nav__btn flex items-center justify-between ">
              ...
              {isAuthenticated ? (
                    ...
                    <div className="dropdown dropdown-end">
                      ...
                      >
                        <li>
                          <Link
                            to={`/users/${id}`}
                            className="justify-between text-gray-50"
                          >
                            Profile
                          </Link>
                        </li>
                        ...
                        <li>
                          <a onClick={handleLogout} className="text-gray-50">
                            Logout
                          </a>
                        </li>
                      </ul>
                ...
                <>
                  <button className="px-4 py-2 text-center rounded-md hidden text-white  bg-slate-700 lg:block mr-3 ">
                    <Link to="/login">Login</Link>
                  </button>

                ...
                <div className="hero__section  relative  ">
                    ...
                    <div className=" ">
                        <div className="hero__content px-[29px]">
                            <div
                                className="hero__subtitle absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 ">
                    ...
                    <div
                        className="flex items-center justify-center gap-4 absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-[100%]  ">
                        <SearchBar/>
                    </div>
                </div>
                {/* =========End Hero========= */}
